        ...
        const productsWithVariants = await Promise.all(
          ...
          products.map(async (product) => {
            ...
            try {
              ...
              const response = await axios.get(
                `http://localhost:5000/api/variant/product/${product._id}`
              );
          ...
          return (
            ...
            >
              ...
              <div className="relative aspect-square overflow-hidden bg-gray-100">
                ...
                <button
                  type="button"
                  className="absolute right-4 top-4 flex h-9 w-9 items-center justify-center rounded-full bg-white text-gray-700 shadow-sm transition-all hover:bg-[#00ff03] hover:text-white"
                >
                  <Heart size={17} />
                </button>
