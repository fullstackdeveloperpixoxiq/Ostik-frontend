...
const ProductDetail = () => {
  ...
  const handleAddToCart = async () => {
    ...
    /*
      Cart API integration will be connected here
      after checking your existing CartController.
    */

    toast.success(
      `${selectedVariant.name} selected — Cart integration next`
    );
  };
  ...
  const handleWishlist = async () => {
    ...
    /*
      Wishlist API integration will be connected
      after checking your existing WishlistController.
    */

    toast.success("Wishlist integration will be connected next");
  };
          ...
          <div>
              ...
              <div className="mt-7">
                ...
                <div className="flex h-11 w-fit items-center overflow-hidden rounded-lg border border-gray-300">
                  ...
                  <button
                    ...
                    className="flex h-full w-11 items-center justify-center transition hover:bg-gray-100"
                  >
            ...
            <div className="mt-7 grid gap-3 sm:grid-cols-2">
              ...
              <button
                ...
                className="flex h-12 items-center justify-center gap-2 rounded-xl border-2 border-black bg-white px-5 text-sm font-bold text-black transition hover:border-[#00ff03] hover:bg-[#00ff03] disabled:cursor-not-allowed disabled:opacity-40"
              >
              ...
              <button
                ...
                className="flex h-12 items-center justify-center rounded-xl bg-black px-5 text-sm font-bold text-white transition hover:bg-[#00ff03] hover:text-black disabled:cursor-not-allowed disabled:opacity-40"
              >
                Buy Now
              </button>
            ...
            <button
              ...
              className="mt-4 flex w-full items-center justify-center gap-2 rounded-xl border border-gray-200 py-3 text-sm font-semibold text-gray-700 transition hover:border-gray-400 hover:text-black"
            >
