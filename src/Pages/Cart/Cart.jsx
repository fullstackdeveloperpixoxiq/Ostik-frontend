      ...
      <main className="mx-auto max-w-7xl px-6 py-10 lg:py-14">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-[1fr_380px]">
            ...
            <div className="space-y-4">
              {cartItems.map((item) => {
                ...
                return (
                  <article
                    key={variant?._id}
                    className="group rounded-3xl border border-gray-100 bg-white p-4 shadow-sm transition-all duration-300 hover:-translate-y-0.5 hover:border-gray-200 hover:shadow-lg sm:p-5"
                  >
                    <div className="flex gap-4 sm:gap-6">
                      {/* IMAGE */}
                      <div className="relative h-28 w-28 shrink-0 overflow-hidden rounded-2xl bg-gray-50 sm:h-36 sm:w-36">
                        <img
                          src={
                            variant?.images?.[0] ||
                            product?.images?.[0]
                      ...
                      <div className="min-w-0 flex-1">
                        <div className="flex items-start justify-between gap-3">
                          <div>
                            <h3 className="line-clamp-2 text-base font-semibold leading-6 text-gray-900 sm:text-lg">
                              {product?.name}
                            </h3>
                          ...
                          <button
                            ...
                            disabled={isRemoving}
                            className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full text-gray-400 transition-all duration-300 hover:bg-red-50 hover:text-red-500 disabled:cursor-not-allowed disabled:opacity-50"
          ...
          <aside className="lg:sticky lg:top-6 lg:h-fit">
            <div className="rounded-3xl border border-gray-100 bg-gray-50 p-6 shadow-sm sm:p-7">
              <h2 className="text-xl font-semibold">
                Order Summary
              </h2>
